...
class Fruit4 {
	...
	public String toString() {
		return String.format("%s, %s, %s,", name, price, expire);
	}
...
class FruitPrice implements Comparator<Fruit4> {
	...
	public class 실습3_7_객체배열이진탐색 {
		private static void sortData(Fruit4[] args, Comparator<Fruit4> key) {

		}

		private static void showData(String msg, Fruit4[] st) {
			System.out.println(msg);
			System.out.println(Arrays.toString(st));
		}

		private static int binarySearch(Fruit4[] st, Fruit4 newFruit4, Comparator<Fruit4> cc_name) {
