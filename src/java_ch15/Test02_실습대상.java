...
public class Test02_실습대상 {
	...
	public static void main(String[] args) {
		...
		members.add(new Member("가정임", 25, "010-123-4562", "서울"));
		members.add(new Member("김하늘", 30, "010-803-6356", "부산"));
		members.add(new Member("김푸름", 24, "010-264-4872", "대전"));
		...
		Member mem2 = members.stream().filter((m) -> m.getAge() > 29).findFirst().orElseGet(Member::new);
